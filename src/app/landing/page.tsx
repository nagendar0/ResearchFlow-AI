        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="text-xs font-semibold text-stone-600 hover:text-stone-900 transition-colors flex items-center gap-1.5 hidden sm:flex"
            >
              <Download size={14} /> Desktop Build
            </button>
            <button 
              onClick={handleLaunchApp}
              className="px-4 py-2 text-xs font-bold bg-[#174f3c] text-white rounded-xl hover:bg-[#123e2f] transition-all shadow-md shadow-[#174f3c]/20 hover:shadow-lg flex items-center gap-1.5"
            >
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-stone-950 border border-stone-800 rounded-2xl p-7 space-y-5 flex flex-col justify-between">
              ...
              <button
                onClick={handleLaunchApp}
                className="w-full py-3 text-xs font-bold bg-[#174f3c] text-white rounded-xl hover:bg-[#123e2f] transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="bg-stone-950 border border-stone-800 rounded-2xl p-7 space-y-5 flex flex-col justify-between">
              ...
              <button
                onClick={handleLaunchApp}
                className="w-full py-3 text-xs font-bold bg-stone-800 text-stone-200 border border-stone-700 rounded-xl hover:bg-stone-700 transition-all flex items-center justify-center gap-2"
              >
